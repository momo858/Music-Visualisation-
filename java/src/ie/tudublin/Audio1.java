...
public class Audio1 extends PApplet {
    ...
    public void setup() {
        ...
        // ab = ai.mix;
        ap = minim.loadFile("Avatar.mp3", 1024);
        ap.play();
        ab = ap.mix;
        colorMode(HSB);
    ...
    public void draw() {
        ...
        switch (mode) {
            ...
            case 5: {
                background(0);
                float particleX = width / 2;
                float particleY = height; // Particles start from the bottom
                float particleSpeed = 5;
                float particleSize = 8;

                // Adjust the number of particles based on the audio amplitude
                int particleCount = (int) map(smoothedAmplitude, 0, 1, 50, 500);
